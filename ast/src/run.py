...
parser.add_argument("--data-train", type=str, default='../../dataset/choi_train.json', help="training data json")
parser.add_argument("--data-val", type=str, default='../../dataset/choi_train.json', help="validation data json")
parser.add_argument("--data-eval", type=str, default='../../dataset/choi_train.json', help="evaluation data json")
parser.add_argument("--label-csv", type=str, default='../../dataset/choi_label.csv', help="csv with class labels")
...
parser.add_argument("--exp-dir", type=str, default="../../save_model", help="directory to dump experiments")
